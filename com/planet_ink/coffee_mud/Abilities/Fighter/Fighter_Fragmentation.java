...
public class Fighter_Fragmentation extends FighterSkill
{
	...
	private final static String localizedName = CMLib.lang()._("Fragmentation");
	...
	public boolean okMessage(final Environmental myHost, final CMMsg msg)
	{
		...
		&&(((Weapon)msg.tool()).weaponClassification()==Weapon.CLASS_THROWN))
		{
			...
			final CMMsg msg2=CMClass.getMsg((MOB)msg.target(),msg.tool(),this,CMMsg.MSG_OK_VISUAL,_("^F^<FIGHT^><T-NAME> fragment(s) in <S-NAME>!^</FIGHT^>^?"));
