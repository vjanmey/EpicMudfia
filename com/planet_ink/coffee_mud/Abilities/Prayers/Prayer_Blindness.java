...
public class Prayer_Blindness extends Prayer
{
	...
	private final static String localizedName = CMLib.lang()._("Blindness");
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto)|CMMsg.MASK_MALICIOUS,auto?"":_("^S<S-NAME> invoke(s) an unholy blindness upon <T-NAMESELF>.^?"));
