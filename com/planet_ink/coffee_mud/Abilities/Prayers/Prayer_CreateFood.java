...
public class Prayer_CreateFood extends Prayer
{
	...
	private final static String localizedName = CMLib.lang()._("Create Food");
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,null,this,verbalCastCode(mob,null,auto),auto?"":_("^S<S-NAME> @x1 for food.^?",prayWord(mob)));
