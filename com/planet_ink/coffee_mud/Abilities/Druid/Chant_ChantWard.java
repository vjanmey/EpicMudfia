...
public class Chant_ChantWard extends Chant
{
	...
	private final static String localizedName = CMLib.lang()._("Chant Ward");
	@Override public String name() { return localizedName; }
	private final static String localizedStaticDisplay = CMLib.lang()._("(Chant Ward)");
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?_("<T-NAME> <T-IS-ARE> protected from chants."):_("^S<S-NAME> chant(s) for a ward against chanting around <T-NAMESELF>.^?"));
