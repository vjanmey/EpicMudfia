...
public class Chant_RedMoon extends Chant
{
	...
	private final static String localizedName = CMLib.lang()._("Red Moon");
	@Override public String name() { return localizedName; }
	private final static String localizedStaticDisplay = CMLib.lang()._("(Red Moon)");
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		{
			mob.tell(_("This place is already under the red moon."));
			return false;
		}
