...
public class Chant_HoneyMoon extends Chant
{
	...
	private final static String localizedName = CMLib.lang()._("Honey Moon");
	@Override public String name() { return localizedName; }
	private final static String localizedStaticDisplay = CMLib.lang()._("(Honey Moon)");
	...
	public void unInvoke()
	{
		...
		if(canBeUninvoked())
			mob.tell(_("You are no longer under the honey moon."));
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		{
			mob.tell(_("This place is already under the honey moon."));
			return false;
		}
