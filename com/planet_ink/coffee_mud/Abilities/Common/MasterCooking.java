...
public class MasterCooking extends Cooking
{
	...
	@Override public String name() { return _("Master Cooking"+cookingID); }
	private static final String[] triggerStrings =_i(new String[] {"MCOOK","MCOOKING","MASTERCOOK","MASTERCOOKING"});
